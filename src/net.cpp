...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Millibyte " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"millibytetools.com", "104.131.110.124"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"millibytetools.com", "testnet-seed.millibytetools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Millibyte is probably already running."), addrBind.ToString().c_str());
        else
